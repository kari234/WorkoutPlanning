...
Window{
    ...
    property int seconds_lap: final_time-(minutes_lap*60)
    property int minutes_pause: real_time_of_pause/60
    property int seconds_pause: real_time_of_pause-(minutes_pause*60)
    ...
    Rectangle {
        ...
        Text { id: label; x: 24; y: 8; width: 108; height: 28; color: "#134981"; text: runscreen.cvik_probehl ? minutes_pause +":"+ seconds_pause : minutes_lap+":"+seconds_lap ; horizontalAlignment: Text.AlignHCenter; font.bold: true;font.pointSize: 19 }
    }
